...
public class OrderService {
    ...
    public OrderCreateResponse createOrder(
        ...
        for (OrderCreateRequest.OrderItemRequest itemRequest
            ...
            // 5. 상품별 주문 금액 계산
            long itemTotalAmount = product.getPrice() * itemRequest.quantity();
    ...
    public OrderPreviewResponse previewOrder(
        ...
        List<OrderPreviewResponse.OrderPreviewItemResponse> previewItems = new ArrayList<>();
        ...
        for (OrderCreateRequest.OrderItemRequest itemRequest
            ...
            // 상품별 금액 계산
            long totalPrice = product.getPrice() * itemRequest.quantity();
    ...
    public Order getCancelableOrder(
        ...
        Order order = orderRepository
                .findById(orderId)
                .orElseThrow(() -> new BusinessException(ErrorCode.REFUND_ORDER_NOT_FOUND));
    ...
    public void cancel(
        ...
        List<OrderItem> orderItems = orderItemRepository.findByOrder(lockedOrder);
